...
namespace WK2018.Data
{
    public class DbInitializer
    {
        public static void Initialize(WKContext context)
        {
            ...
            new List<Team>
            {
                new Team { ID=1, Naam="Rusland", Punten=0, PouleID=1 },
                new Team { ID=2, Naam="Saudi-Arabië", Punten=0, PouleID=1 },
                new Team { ID=3, Naam="Egypte", Punten=0, PouleID=1 },
                new Team { ID=4, Naam="Uruguay", Punten=0, PouleID=1 },
                new Team { ID=5, Naam="Portugal", Punten=0, PouleID=2 },
                new Team { ID=6, Naam="Spanje", Punten=0, PouleID=2 },
                new Team { ID=7, Naam="Marokko", Punten=0, PouleID=2 },
                new Team { ID=8, Naam="Iran", Punten=0, PouleID=2 },
                new Team { ID=9, Naam="Frankrijk", Punten=0, PouleID=3 },
                new Team { ID=10, Naam="Australië", Punten=0, PouleID=3 },
                new Team { ID=11, Naam="Peru", Punten=0, PouleID=3 },
                new Team { ID=12, Naam="Denemarken", Punten=0, PouleID=3 },
                new Team { ID=13, Naam="Argentinië", Punten=0, PouleID=4 },
                new Team { ID=14, Naam="IJsland", Punten=0, PouleID=4 },
                new Team { ID=15, Naam="Kroatië", Punten=0, PouleID=4 },
                new Team { ID=16, Naam="Nigeria", Punten=0, PouleID=4 },
                new Team { ID=17, Naam="Brazilië", Punten=0, PouleID=5 },
                new Team { ID=18, Naam="Zwitserland", Punten=0, PouleID=5 },
                new Team { ID=19, Naam="Costa Rica", Punten=0, PouleID=5 },
                new Team { ID=20, Naam="Servië", Punten=0, PouleID=5 },
                new Team { ID=21, Naam="Duitsland", Punten=0, PouleID=6 },
                new Team { ID=22, Naam="Mexico", Punten=0, PouleID=6 },
                new Team { ID=23, Naam="Zweden", Punten=0, PouleID=6 },
                new Team { ID=24, Naam="Zuid-Korea", Punten=0, PouleID=6 },
                new Team { ID=25, Naam="België", Punten=0, PouleID=7 },
                new Team { ID=26, Naam="Panama", Punten=0, PouleID=7 },
                new Team { ID=27, Naam="Tunesië", Punten=0, PouleID=7 },
                new Team { ID=28, Naam="Engeland", Punten=0, PouleID=7 },
                new Team { ID=29, Naam="Polen", Punten=0, PouleID=8 },
                new Team { ID=30, Naam="Senegal", Punten=0, PouleID=8 },
                new Team { ID=31, Naam="Colombia", Punten=0, PouleID=8 },
                new Team { ID=32, Naam="Japan", Punten=0, PouleID=8 },
